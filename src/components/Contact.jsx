...
import emailljs from '@emailjs/browser'
    ...
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      <motion.div variants={slideIn('left', 'tween', 0.2,1)} className='flex-[0.75] bg-black-100 p-8 rounded-2xl'>
        ...
        <form ref={formRef} onSubmit={onSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <button type="submit" className='bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold shadow-mt shadow-primary'>{loading ? 'sending...':'Send'}</button>
        </form>
      </motion.div>
